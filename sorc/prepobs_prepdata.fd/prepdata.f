...
CDONG     $     '.DTMMXGS MXGS NUL TP01 TP03 TP06 TP12 TP24 TOSS TOCC HBLCS')
     $     'NUL NUL NUL TP01 TP03 TP06 TP12 TP24 TOSS TOCC HBLCS')
...
c - end of CEILING processing
     ...
     $                                   NOBS3(5),IRET,'DOSW HOSW POSW')
            CALL UFBINT(IUNITP,OBS2_8(44),1,1,IRET,'HSALGV')
