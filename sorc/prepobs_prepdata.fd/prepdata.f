...
C IQMLIM IS PREPBUFR TBL V. LIMIT FOR ACCEPTING REPORTS (HERE SET TO 16)
      ...
      IZBEST = 99
      IWBEST = 99
C      write(*,*) 'JDONG1: NLEV=', NLEV,
C     $    ' IQ(1,*)=',IQ(1,1),IQ(1,2),IQ(1,3),IQ(1,4),IQ(1,5)
      DO I = 1,NLEV
         IQ1 = IQ(I,1)
...
C      write(*,*) 'JDONG2: I= ', I, MOD(IQ(I,3),20), ISATOB
...
C      write(*,*) 'JDONG3: IZBEST=',IZBEST, IQ1
         IZBEST = MIN(IQ1,IZBEST)
C      write(*,*) 'JDONG4: ',IZBEST,IWBEST,IZLAST,ITLAST,IWLAST
C IF KTEMP = T, THEN ALSO EXAMINE TEMP PREPBUFR TABLE VALUE FOR IZBEST
...
C      write(*,*) 'JDONG5: ',IZBEST,IWBEST,IZLAST,ITLAST,IWLAST
C      write(*,*) ' '
      ENDDO
...
C      write(*,*) 'JDONG6: ',ISATOB,IDATA(15),IDATA(9),IDATA(9)/10
      IF(ISATOB.EQ.0.AND.IZBEST.GE.IQMLIM.AND.IDATA(15).EQ.0)  THEN
         ...
         END IF
      END IF
C      write(*,*) 'JDONG7: ADPTYP= ', ADPTYP,' ',STNID(1:4),LSMASS
